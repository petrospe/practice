...
**8)** Το πεδίο _email_ δεν ελεγχεται πουθενά αν εισάγουμε email ή όχι. H _class practice\_form_ κανει _extend_ την _abstract class moodleform_ η οποία έχει την μέθοδο _validate_ που μπορούμε να τη χρησιμοποιήσουμε για το validation του _email_.
